...
execute at @s run summon item ~ ~ ~ {Item:{id:"minecraft:barrier", count:1}, Tags:["tac.new_item"]}
...
execute if score #input_count tac.temp matches 0 run item replace block ~ ~ ~ container.9 with air