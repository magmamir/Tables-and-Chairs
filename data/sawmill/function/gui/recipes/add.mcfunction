...
data modify storage sawmill:temp matchedRecipes[-1].display.components."minecraft:custom_data".lockedSlot set value 1b
data modify storage sawmill:temp matchedRecipes[-1].display.components."minecraft:custom_data".isRecipeItem set value 1b
