execute if data block ~ ~ ~ Items[{Slot:9b}] if data block ~ ~ ~ Items[{Slot:0b}] at @p run summon item ~ ~0.4 ~ {PickupDelay:2s,Item:{id:"minecraft:stone",count:1},Tags:[chk.empty_item]}
...
data modify block ~ ~ ~ Items append value {id:air,count:0,Slot:0b}
