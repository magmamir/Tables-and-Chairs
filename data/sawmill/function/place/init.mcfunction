scoreboard players set @s chk.distance 50

execute unless score @s chk.fail matches 0.. run scoreboard players set @s chk.fail 0
...
execute if score @s chk.fail matches 7.. run scoreboard players set @s chk.fail 0
