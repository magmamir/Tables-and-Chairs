...
#summon item -29999983 -64 14400 {UUID:[I; 0, 0, 0, 7], Item:{id:"minecraft:stone",count:1}}
#data modify entity 0-0-0-0-7 Item set from storage sawmill:data recipes[-1].display

setblock -29999982 ~ 14400 oak_sign{front_text:{messages:['{"text":""}','[{"text":"Cost: ","color":"gray","italic":false},{"text":"x","color":"white"},{"score":{"name":"#material_cost","objective":"tac.io"},"color":"white"}]','[{"text":"Produces: ","color":"gray","italic":false},{"text":"x","color":"white"},{"score":{"name":"#produces","objective":"tac.temp"},"color":"white","italic":false}]','{"text":""}']}}
...
data modify storage sawmill:data recipes[-1].display.components."minecraft:lore" append from block -29999982 ~ 14400 front_text.messages[1]
data modify storage sawmill:data recipes[-1].display.components."minecraft:lore" append from block -29999982 ~ 14400 front_text.messages[2]
