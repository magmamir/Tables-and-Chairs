...
#Summon Item Display
execute if entity @s[y_rotation=-45..45 ] positioned ~ ~0.4062 ~ run summon item_display ~ ~ ~ {teleport_duration:1,Rotation:[180f,0f],item:{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,view_range:0.67f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.model","chk.not_done","tac.V5.0"]}
execute if entity @s[y_rotation=45..135 ] positioned ~ ~0.4062 ~ run summon item_display ~ ~ ~ {teleport_duration:1,Rotation:[270f,0f],item:{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,view_range:0.67f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.model","chk.not_done","tac.V5.0"]}
execute if entity @s[y_rotation=135..225] positioned ~ ~0.4062 ~ run summon item_display ~ ~ ~ {teleport_duration:1,Rotation:[0f,  0f],item:{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,view_range:0.67f,width:1,height:1,Tags:["chk.block","smithed.block","chk.chair","chk.chair.model","chk.not_done","tac.V5.0"]}
...
# execute as @s[y_rotation=135..225] positioned ~ ~0.36 ~ run summon armor_stand ~ ~ ~ {NoGravity:1b,NoBasePlate:1b,Small:1b,ShowArms:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}}],Tags:["chk.block","chk.chair","chk.reg_chair","chk.not_done"],Rotation:[90f]}
# execute as @s[y_rotation=225..315] positioned ~ ~0.36 ~ run summon armor_stand ~ ~ ~ {NoGravity:1b,NoBasePlate:1b,Small:1b,ShowArms:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}}],Tags:["chk.block","chk.chair","chk.reg_chair","chk.not_done"],Rotation:[180f]}
# execute as @s[y_rotation=-45..45] positioned ~ ~0.36 ~ run summon armor_stand ~ ~ ~ {NoGravity:1b,NoBasePlate:1b,Small:1b,ShowArms:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}}],Tags:["chk.block","chk.chair","chk.reg_chair","chk.not_done"],Rotation:[270f]}
# execute as @s[y_rotation=45..135] positioned ~ ~0.36 ~ run summon armor_stand ~ ~ ~ {NoGravity:1b,NoBasePlate:1b,Small:1b,ShowArms:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}}],Tags:["chk.block","chk.chair","chk.reg_chair","chk.not_done"],Rotation:[0f]}
