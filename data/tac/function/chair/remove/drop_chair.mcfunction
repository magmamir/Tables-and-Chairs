...
# execute if entity @s[tag=chk.chair.basic,tag=chk.chair.quartz] at @s run summon item ~ ~0.7 ~ {PickupDelay:13s,Item:{id:"jungle_trapdoor",count:1,components:{"minecraft:custom_model_data": 9001011, Tags:[chk.chair,chk.chair.quartz,chk.chair.basic], display:{Name:"{\"text\":\"Basic Quartz Chair\",\"italic\":\"false\"}", Lore:['[{"text":"Place any Colored Carpet ","italic":false,"color":"gold"},{"text":"","italic":false,"color":"dark_purple"}]','[{"text":"Below Chair","italic":false,"color":"gray"},{"text":" to add a Cushion","color":"gold"}]']}}}}
