...
summon item_display ~ ~ ~ {item:{id:"jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,Tags:["chk.block","chk.table","chk.table.legs","chk.not_done","smithed.block","tac.V5.0"],view_range:0.8f,width:1,height:1}
#Summon Item Display for Table Top
summon item_display ~ ~ ~ {item:{id:"jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,Tags:["chk.block","smithed.block","chk.table","chk.table.top","tac.V5.0"],view_range:0.8f,width:1,height:1,Rotation:[0f,0f,0f]}
