#Set the Table Top
data modify entity @s HandItems[0] set value {components:{"minecraft:custom_model_data":9004300},id:"minecraft:jungle_trapdoor",count:1}
...
# Basic1
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.basic.1 chk.style run data modify entity @s ArmorItems[3] set value {components:{"minecraft:custom_model_data":9004301},id:"minecraft:jungle_trapdoor",count:1}
...
# Basic2
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.basic.2 chk.style run data modify entity @s ArmorItems[3] set value {components:{"minecraft:custom_model_data":9004311},id:"minecraft:jungle_trapdoor",count:1}
...
# Carved1
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.carved.1 chk.style run data modify entity @s ArmorItems[3] set value {components:{"minecraft:custom_model_data":9004321},id:"minecraft:jungle_trapdoor",count:1}
...
# Carved2
execute if score @p[distance=0..6,scores={chk.style=0..}] chk.style = Table.style.carved.2 chk.style run data modify entity @s ArmorItems[3] set value {components:{"minecraft:custom_model_data":9004331},id:"minecraft:jungle_trapdoor",count:1}
