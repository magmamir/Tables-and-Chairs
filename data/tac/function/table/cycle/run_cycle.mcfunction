...
## V4.0
#Basic 1
# execute if entity @p[distance=0..6,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["chk.furniture_hammer"]}}}}] if entity @s[tag=chk.table.basic.1] run function tac:table/cycle/cycle_basic_1
# execute if entity @p[distance=0..6,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["chk.furniture_hammer"]}}}}] if entity @s[tag=chk.table.basic.2] run function tac:table/cycle/cycle_basic_2
# execute if entity @p[distance=0..6,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["chk.furniture_hammer"]}}}}] if entity @s[tag=chk.table.carved.1] run function tac:table/cycle/cycle_carved_1
# execute if entity @p[distance=0..6,nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["chk.furniture_hammer"]}}}}] if entity @s[tag=chk.table.carved.2] run function tac:table/cycle/cycle_carved_2
# execute if entity @p[distance=0..6,nbt={SelectedItem:{id:"minecraft:jungle_trapdoor",components:{"minecraft:custom_model_data":1}}}] if entity @s[tag=chk.table.basic.1] run function tac:table/cycle/cycle_basic_1
