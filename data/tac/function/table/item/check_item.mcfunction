...
#Mob Trophy
execute if entity @s[nbt={SelectedItem:{id:"minecraft:jungle_trapdoor",components:{"minecraft:custom_data":{Tags:[chk.trophy]}}}}] positioned ~ ~0.5 ~ run function tac:table/item/place/mob_trophy
