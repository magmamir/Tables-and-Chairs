...
execute if block ~ ~ ~ end_rod run summon item ~ ~0.7 ~ {PickupDelay:13s,Motion:[0.01,0.2,0.01],Item:{id:"end_rod",count:1}}
# Flower Pots
execute if block ~ ~ ~ #minecraft:flower_pots run summon item ~ ~0.7 ~ {PickupDelay:13s,Motion:[0.01,0.2,0.01],Item:{id:"flower_pot",count:1}}
