...
execute if entity @s[tag=chk.table.item.inkquill] at @s run summon item ~ ~0.6 ~ {PickupDelay:13s,Motion:[-0.02,0.2,-0.005],Item:{id:"feather",count:1}}
...
data modify entity @s item set value {id:"minecraft:orange_stained_glass",count:1,components:{"minecraft:custom_model_data":9006020}}
