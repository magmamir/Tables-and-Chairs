...
#Torch
execute as @s[tag=chk.table.torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:torch",count:1}},limit=1]
execute as @s[tag=chk.table.torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run setblock ~ ~1 ~ torch
#Redstone Torch
execute as @s[tag=chk.table.redstone_torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:redstone_torch",count:1}},limit=1]
execute as @s[tag=chk.table.redstone_torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run setblock ~ ~1 ~ redstone_torch
#Soul Torch
execute as @s[tag=chk.table.soul_torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:soul_torch",count:1}},limit=1]
execute as @s[tag=chk.table.soul_torch] if block ~ ~ ~ #minecraft:trapdoors[open=true] run setblock ~ ~1 ~ soul_torch
#Lantern
execute as @s[tag=chk.table.lantern] if block ~ ~ ~ #minecraft:trapdoors[open=true] run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:lantern",count:1}},limit=1]
execute as @s[tag=chk.table.lantern] if block ~ ~ ~ #minecraft:trapdoors[open=true] run setblock ~ ~1 ~ lantern
#Soul Lantern
execute as @s[tag=chk.table.soul_lantern] if block ~ ~ ~ #minecraft:trapdoors[open=true] run kill @e[distance=0..2,type=item,nbt={Item:{id:"minecraft:soul_lantern",count:1}},limit=1]
