...
# execute as @s store result score Bench_Cycle chk.cycle run data get entity @s item.components."minecraft:custom_model_data"
# execute as @s store result entity @s item.components."minecraft:custom_model_data" int 1 run scoreboard players add Bench_Cycle chk.cycle 1
...
execute store result entity @s item.components."minecraft:custom_model_data" int 1 run scoreboard players get Bench_Cycle chk.cycle
