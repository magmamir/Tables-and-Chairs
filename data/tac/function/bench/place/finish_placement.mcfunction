...
execute store result entity @s item.components."minecraft:custom_model_data" int 1 run scoreboard players operation Current_Bench chk.temp += @p[distance=0..6,scores={chk.style=0..}] chk.style
