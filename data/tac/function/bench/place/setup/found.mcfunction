...
#Summon Item Display
execute if entity @s[y_rotation=-45..45 ] positioned ~ ~0.35 ~ run summon item_display ~ ~ ~ {Rotation:[180f,0f],item:{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,view_range:0.67f,width:1,height:1,Tags:["chk.block","smithed.block","chk.bench","chk.bench.model","chk.not_done","tac.V5.0","chk.facing.south"]}
...
execute if entity @s[y_rotation=135..225] positioned ~ ~0.35 ~ run summon item_display ~ ~ ~ {Rotation:[0f,  0f],item:{id:"minecraft:jungle_trapdoor",count:1,components:{"minecraft:custom_model_data":9000000}},item_display:head,view_range:0.67f,width:1,height:1,Tags:["chk.block","smithed.block","chk.bench","chk.bench.model","chk.not_done","tac.V5.0","chk.facing.north"]}
