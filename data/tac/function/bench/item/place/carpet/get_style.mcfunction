...
# Reset the Cushion's "minecraft:custom_model_data"
execute as @e[limit=1,distance=0..0.6,tag=chk.bench.cushion] at @s run data modify entity @s item.components."minecraft:custom_model_data" set value 9010000
