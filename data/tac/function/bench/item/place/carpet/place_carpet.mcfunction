...
execute as @s store result entity @s item.components."minecraft:custom_model_data" int 1 run scoreboard players operation Current_Carpet_CMD chk.style += Current_Carpet chk.temp
